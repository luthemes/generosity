# Generosity
Generosity is a next-generation theme designed to work with ClassicPress, offering an ideal experience for showcasing your site's content.
...
## Child themes
Since Generosity is a parent theme, you'll want to create a child theme if you plan on making any customizations. Don't know how to make a child theme? Just follow the steps below.

* Create a theme folder in your `wp-content/themes` directory called `Generosity-child`.
* Create a `style.css` file within your theme folder.
* At the top of your `style.css` file, add the below information.

<pre>
/*!
 * Theme Name: Generosity Child
...
This theme makes use of several images
* "The Andromeda Galaxy, Messier 31" by kees scherer is marked with Public Domain Mark 1.0.
* "Messier 104 (M104), Sombrero Galaxy" by aeroman3 is marked with Public Domain Mark 1.0.
* "laptop computer 2006 to current" by elizabeth.hargis is marked with Public Domain Mark 1.0.

## Copyright & License
Generosity is licensed under the GNU Public License, version 2 or  later (GPL).
