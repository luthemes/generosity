...
class Options {
	...
	public static function get( $name = '' ) {
		...
		$settings = wp_parse_args( get_option( 'generosity_settings', $defaults ), $defaults );
	...
	public static function defaults() {
		...
		return apply_filters( 'generosity/settings/options/defaults', [
			// 1.0.0
			'disable_emoji'        => true,
