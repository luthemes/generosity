...
( function( $ ) {
	...
	parentLink = container.querySelectorAll( '.has-children, .page_item_has_children' );
	...
	( function( container ) {
		var touchStartFn, i,
			parentLink = container.querySelectorAll( '.has-children > a, .page_item_has_children > a' );
